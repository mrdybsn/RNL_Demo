...
const ToastMessage: FC<ToastMessageProps> = ({
  ...
  return (
    <>
    <div className={`fixed top-40 right-0 md:right-4 z-50 flex items-center w-full max-w-xs p-4 text-black bg-green-100 rounded-lg shadow-lg transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`} role="alert">
